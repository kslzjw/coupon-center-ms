package com.zjw.coupon.template.service;
...
import com.zjw.coupon.template.converter.CouponTemplateConverter;
import com.zjw.coupon.template.dao.CouponTemplateDao;
import com.zjw.coupon.template.dao.entity.CouponTemplate;
import com.zjw.coupon.template.service.intf.CouponTemplateService;
...
public class CouponTemplateServiceImpl implements CouponTemplateService {
    ...
    public List<CouponTemplateInfo> searchTemplate(CouponTemplateInfo request) {
        com.zjw.coupon.template.dao.entity.CouponTemplate example = com.zjw.coupon.template.dao.entity.CouponTemplate.builder()
                .shopId(request.getShopId())
                .category(CouponType.convert(request.getType()))
                .available(request.getAvailable())
                .name(request.getName())
...
//        templateDao.findAll(Example.of(example), page);
        List<com.zjw.coupon.template.dao.entity.CouponTemplate> result = templateDao.findAll(Example.of(example));
    ...
    public Map<Long, CouponTemplateInfo> getTemplateInfoMap(Collection<Long> ids) {
        ...
        List<com.zjw.coupon.template.dao.entity.CouponTemplate> templates = templateDao.findAllById(ids);
